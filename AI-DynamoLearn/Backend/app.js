...
const __filename = "F:/SEM4/SGP/AI-DynamoLearn/Frontend/app.js"; // Remove 'file://'
const __dirname = "F:/SEM4/SGP/AI-DynamoLearn/Backend";

const app = express();
const port = process.env.PORT || 5000;
app.use(express.static(path.join("F:/SEM4/SGP/AI-DynamoLearn/Frontend", "client/build")));
...
mongoose.connect('', { // Update with your MongoDB URI
...
app.get("/auth", (req, res) => {
  res.sendFile(path.join("F:/SEM4/SGP/AI-DynamoLearn/Frontend", "client/build", "index.html"));
});
